...
def random_phrase():
    ppl = ["ROYALE", "ROYALE", "JAX", "CYBEE-JAX", "PowerDDoSJAX", "King•ROYALE", "JAX", "JAX", "JAX", "JAX"]
    phrase = ["Tools", "Ddos Attack", "Buatan", "xxJAXxx", "Jangan Di Gunakan", "Untuk Menyerang Situs", "NASA", "POLRI.GO.ID", "BIGETRON", "Dan Lain Lain"]
